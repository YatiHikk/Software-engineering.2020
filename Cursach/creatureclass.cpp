...
Creatureclass::Creatureclass(QString nameC, int ctgC, QString upctgC, QStringList subctgC, QString descripC, QString pictureC, QStringList enemiesC, QStringList hintsC)
{
    name = nameC;
    ctg = ctgC;
    upctg = upctgC;
